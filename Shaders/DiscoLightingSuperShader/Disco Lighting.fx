...
// Walls
//--------------------------------------------------------------//
string DiscoLighting_Walls_Room : ModelData = "Cube.3ds";
...
float4 lightPos <
   ...
   bool Normalize =  false; > = ( 0.00, 28.00, 0.00, 1.00 );
...
<
   string ResourceName = "TilesDOT3.tga";
>;
...
// Object
//--------------------------------------------------------------//
string DiscoLighting_Object_Cracked_Quad_Object : ModelData = "CrackedQuad.3ds";
...
// Light
//--------------------------------------------------------------//
string DiscoLighting_Light_Light_Ball : ModelData = "Sphere.3ds";
